...
PBMC1_origin<-Read10X(data.dir = 'PBMC1', gene.column = 2, unique.features = TRUE)
PBMC1<-Read10X(data.dir = 'PBMC1', gene.column = 2, unique.features = TRUE)
PBMC2_origin<-Read10X(data.dir = 'PBMC2', gene.column = 2, unique.features = TRUE)
PBMC2<-Read10X(data.dir = 'PBMC2_3500', gene.column = 2, unique.features = TRUE)
...
DSB1_matrix<-read.csv("DSB_adt+vdj_PBMC1.csv",row.names = 1)
DSB2_matrix<-read.csv("DSB_adt+vdj_PBMC2.csv",row.names = 1)
DSB3_matrix<-read.csv("DSB_adt+vdj_PBMC3.csv",row.names = 1)
...
PBMC1_5000[['Protein']] = CreateAssayObject(counts = DSB1_matrix)
